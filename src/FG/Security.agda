...
mutual
  ...
  ... | β' ∧ β⊆β' ∧ ⟨  Σ₁'≈Σ₂' , Valueᴸ _ (Lbl ℓ₁) ⟩ with tiniᴸ x₂ y₂ Σ₁'≈Σ₂' {!!} pc⊑A -- θ₁≈θ₂
  ...
  tiniᴸ (Test₁ x₁ x₂ ℓ₁⊑ℓ₂ refl) (Test₁ y₁ y₂ _ refl) Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A
    | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , Valueᴴ pc⋤ℓ₁' pc⋤ℓ₂' ⟩ with tiniᴸ x₂ y₂ Σ₁'≈Σ₂' {!!} pc⊑A -- θ₁≈θ₂
  ... |  β'' ∧ β'⊆β'' ∧ ⟨ Σ₃≈Σ₃' , v≈ ⟩
  ...
  ... | _ ∧ _ ∧ ⟨ Σ₁'≈Σ₂' , Valueᴸ _ (Lbl ℓ₁) ⟩ with tiniᴸ x₂ y₂ Σ₁'≈Σ₂' {!!} pc⊑A -- θ₁≈θ₂
  ...
  -- False vs True
  tiniᴸ (Test₂ x₁ x₂ ℓ₁⋤ℓ₂ refl) (Test₁ y₁ y₂ ℓ₁⊑ℓ₂ refl) Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A with tiniᴸ x₁ y₁ Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A
  ... | _ ∧ _ ∧ ⟨ Σ₁'≈Σ₂' , Valueᴸ _ (Lbl ℓ₁) ⟩ with tiniᴸ x₂ y₂ Σ₁'≈Σ₂' {!θ₁≈θ₂!} pc⊑A -- θ₁≈θ₂
  ...
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , v₁≈v₂ ⟩ with tiniᴸ x₁ x₅ Σ₁'≈Σ₂' {!!} pc⊑A -- θ₁≈θ₂
  ...
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , Valueᴸ ℓ⊑A (Inl v₁≈v₂) ⟩ = {!!} --  tini {{ ? }} {{ ? }} x₂ x₅ ⟨ Σ₁'≈Σ₂' , refl ⟩ (v₁≈v₂ ∷ ?) -- θ₁≈θ₂
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , (Valueᴴ ℓ₁⋤A ℓ₂⋤A) ⟩ = {!!} -- tiniᴴ Σ₁'≈Σ₂' x₂ x₅ (join-⋤₂ ℓ₁⋤A) (join-⋤₂ ℓ₂⋤A)
  ...
  tiniᴸ (Case₂ x refl x₂) (Case₂ x₃ refl x₅) Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A with tiniᴸ x x₃ Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , Valueᴸ ℓ⊑A (Inr v₁≈v₂) ⟩ = {!!} -- tini x₂ x₅ ⟨ Σ₁'≈Σ₂' , refl ⟩ (v₁≈v₂ ∷ θ₁≈θ₂)
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , Valueᴴ ℓ₁⋤A ℓ₂⋤A ⟩ = {!!} -- tiniᴴ Σ₁'≈Σ₂' x₂ x₅ (join-⋤₂ ℓ₁⋤A) (join-⋤₂ ℓ₂⋤A)

  tiniᴸ (Pair x x₁) (Pair x₂ x₃) Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A with tiniᴸ x x₂ Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , v₁≈v₁' ⟩ with tiniᴸ x₁ x₃ Σ₁'≈Σ₂' {!!} pc⊑A -- θ₁≈θ₂
  ... | β'' ∧ β'⊆β'' ∧ ⟨ Σ₁''≈Σ₂'' , v₂≈v₂' ⟩ = β'' ∧ trans-⊆ β⊆β' β'⊆β'' ∧ ⟨ Σ₁''≈Σ₂'' , Valueᴸ pc⊑A (Pair {!!} {!!}) ⟩ -- (Pair v₁≈v₁' v₂≈v₂') ⟩
  ...
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , E.Valueᴸ ℓ⊑A (E.Lbl ℓ) ⟩ = {!!} -- tini x₂ x₄ ⟨ Σ₁'≈Σ₂' , refl ⟩ θ₁≈θ₂
  ... | β' ∧ β⊆β' ∧ ⟨ Σ₁'≈Σ₂' , (Valueᴴ ℓ₁⋤A ℓ₂⋤A) ⟩ = {!!} -- tiniᴴ Σ₁'≈Σ₂' x₂ x₄ (trans-⋤ pc'⊑pc'' ℓ₁⋤A) (trans-⋤ pc'⊑pc''' ℓ₂⋤A)
  ...
  tiniᴸ (New x) (New x₁) Σ₁≈Σ₂ θ₁≈θ₂ pc⊑A = {!!}
