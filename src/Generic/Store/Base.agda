...
-- Σ [ ℓ ↦ M ]ˢ updates store Σ with ℓ ℓabeℓed memory M.
_[_↦_]ˢ : Store -> (ℓ : Label) -> Memory ℓ -> Store
_[_↦_]ˢ  Σ ℓ M ℓ' with ℓ ≟ ℓ'
_[_↦_]ˢ Σ ℓ M .ℓ | yes refl = M
_[_↦_]ˢ Σ ℓ M ℓ' | no ¬p = Σ ℓ'
